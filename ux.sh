...
(pkg upgrade -y && apt-get update -y && apt install -y wget proot && wget https://github.com/anonymousx97/ubuntu/raw/master/ubuntu.sh && chmod +x ubuntu.sh &&  ./ubuntu.sh -y && ./startubuntu.sh | apt -qq update && apt -qq upgrade -y && \
